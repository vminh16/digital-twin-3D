...
CANDIDATE_ID="E3-chair-observation-scale-30k-control-v1"
...
if [[ -f "${OUTPUT_DIR}/experiment_report.json" ]] \
    ...
    echo "ERROR: partial E3-30k output has no recovery checkpoint: ${OUTPUT_DIR}" >&2
    exit 2
fi
...
echo "E3 paired 30000-step control ready: ${OUTPUT_DIR}"
